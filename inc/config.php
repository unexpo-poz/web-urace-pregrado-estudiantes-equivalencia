...
$tLapso				= ' Lapso 2022-2';
$lapsoProceso		= '2022-2';
//$laBitacora			= 'Q:/AppServ/www/log/pregrado/estudiantes/cambio/equivalencias_2015-1.log';
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/equivalencia_'.date('m-Y').'_'.$lapsoProceso;
$inscHabilitada		= true;
$modoInscripcion	= '1'; // 1: Inscripcion, 2: Inclusion y Retiro

$basededatos	= "ADMISION";
$usuariodb = "SYSADM";
$clavedb = "SYSADM";

$basededatos1	= "CENTURA-DACE";
$usuariodb1 = "C";
$clavedb1 = "C";
